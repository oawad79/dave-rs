    ...
    pub fn new() -> Self {
        ...
        let tiled_map = load_map(
            ...
            &[
                ...
                ("images/dangerousdave1-sheet.png", resources.get_texture("dangerousdave1-sheet").clone()),
...
impl Scene for EntryScreen {
    fn update(&mut self) -> Option<SceneChange> {
        ...
        if is_key_down(KeyCode::Space) {
            return Some(SceneChange::Game{level: 1, retry: false, cheat: false, warp_zone: false});
        }
